...
if (isset($_POST['submit'])) {
    ...
    contact_subject) VALUES ('$name','$email','$message','$subject')";
            ...
            <div class="container">
                <div class="row justify-content-between">
                    <div class="col-md-7 col-lg-6 col-xl-5">
                        ...
                        <form class="contact-form" method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="contact_form_submit">
                            ...
                            <div class="info-area">
                                <div class="info-item">
                                    ...
                                    <div class="info-content">
                                        ...
                                        <a href="Tel:+923082854205">+923082854205</a>
                                    </div>
                                </div>
                                <div class="info-item">
                                    <div class="info-thumb">
                                    ...
                                    <div class="info-content">
                                        ...
                                        <a href="Mailto:faiqyaseen223@gmail.com"><span class="__cf_email__" data-cfemail="cea7a0a8a18e8ca1a2abbaa1">[email&#160;protected]</span> .com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
