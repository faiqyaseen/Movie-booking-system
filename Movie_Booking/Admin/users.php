            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4 m-auto mt-5">
                    ...
                    if (mysqli_num_rows($result1) > 0) {
                        ...
                        echo "<li class='page-item {$prevdisable}'><a class='page-link' href='users.php?page=" . ($page - 1) . "'>Previous</a></li>";
                        ...
                        echo "<li class='page-item {$nextdisable}'><a class='page-link' href='users.php?page=" . ($page + 1) . "'>Next</a></li>";
                        echo "</ul>
                            </nav>";
                    }
                    ?>
