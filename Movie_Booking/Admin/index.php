...
if (isset($_POST['login'])) {
    if (empty($_POST['username']) || empty($_POST['password'])) {
        ...
        $sql =  "SELECT id, username,first_name ,last_name, role FROM tbl_emp WHERE username = '{$username}' AND password = '{$password}'";
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    ...
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
