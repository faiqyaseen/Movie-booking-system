...
<section class="details-banner bg_img" data-background="
                ...
                $id = $_GET['id'];
                include "config.php";
                $sql = mysqli_query($conn, "SELECT * FROM movie WHERE movie_id = $id");
                while ($row1 = mysqli_fetch_assoc($sql)) {
                    echo "Admin/movie-gallery/{$row1['images']}";
                }
        ...
        <div class="details-banner-wrapper">
            ...
            <div class="details-banner-content offset-lg-3">
                ...
                <?php
                                    $sql = mysqli_query($conn, "SELECT * FROM movie WHERE movie_id = $id");
                                    while ($row1 = mysqli_fetch_assoc($sql)) {
                    echo "<a href='#0'>".ucwords($row1['movie_title'])."</a>";
                }
                ...
                <a href="#0" class="button">
                    <?php
                    $sql = mysqli_query($conn, "SELECT * FROM movie LEFT JOIN genre
                        ON movie.gen_id = genre.gen_id WHERE movie_id = $id");
                    while ($row1 = mysqli_fetch_assoc($sql)) {
                        echo $row1['genre'];
                    }
                ...
                <div class="social-and-duration">
                    ...
                    <ul class="social-share">
                        <li><a href="https://www.facebook.com/faiqali23"><i class="fab fa-facebook-f"></i></a></li>
                        <li><a href="https://twitter.com/faiq_yaseen"><i class="fab fa-twitter"></i></a></li>
...
<section class="book-section bg-one">
    <div class="container">
        <div class="book-wrapper offset-lg-3">
            ...
            <a href="ticket-plan.php?id=<?php echo $id ?>" class="custom-button">book tickets</a>
        </div>
    </div>
</section>
<!-- ==========Book-Section========== -->
