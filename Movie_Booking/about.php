    ...
    <div class="container">
        ...
        <div class="speaker--slider">
            <div class="speaker-slider owl-carousel owl-theme">
                <?php
                include "config.php";
                $sql = mysqli_query($conn, "SELECT * FROM tbl_emp ORDER BY id DESC");
                while ($row1 = mysqli_fetch_assoc($sql)) {
                ?>
                <div class="speaker-item">
                    <div class="speaker-thumb">
                        <a href="event-speaker.html">
                            <img src="Admin/upload/<?php echo $row1['image'] ?>" height="300" alt="speaker">
                        </a>
                    </div>
                    <div class="speaker-content">
                        <h5 class="title">
                            <a href="event-speaker.html">
                                <?php echo ucwords($row1['first_name']). " " . ucwords($row1['last_name']) ?>
                            </a>
                        </h5>
